...
//    handles the searchTextField and calls api calling method
  ...
  public void sendLocationAndSetFronted(){
   ...
   weatherData  = new WeatherData( searchLocationTextField.getText());
    ...
    weatherVisualImageView.setImage(new Image(weatherData.getWeatherImagePath()));
   wallpaperBox.setFill(new ImagePattern(new Image(weatherData.getbackgroundImagePath()))); //DO NOT call it before getWeatherImagePath()
...
// \u00B0
    ...
    // setting day1image
    day1ImageView.setImage(new Image(weatherData.getDate1ImagePath()));
    // setting day2 image
    day2ImageView.setImage(new Image(weatherData.getDate2ImagePath()));
    // setting day3 image
    day3ImageView.setImage(new Image(weatherData.getDate3ImagePath()));
    // setting day4 image
    day4ImageView.setImage(new Image(weatherData.getDate4ImagePath()));
